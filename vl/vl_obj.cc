 ...
 *                                                                        *
 *========================================================================*
 $Id: vl_obj.cc,v 1.3 2010/09/19 20:22:31 stevew Exp $
 *========================================================================*/
...
vl_decl::var_setup(vl_var *var, int vtype)
{
    ...
    case Tri0Decl:
        if (var->net_type == REGnone ||
            ...
            var->setbits(BitL);
            var->strength.str0 = var->strength.str1 = STRpull;
            return;
        }
        break;
    case Tri1Decl:
    ...
    case Supply0Decl:
        if (var->net_type == REGnone ||
            ...
            var->setbits(BitL);
            var->strength.str0 = var->strength.str1 = STRsupply;
            return;
        }
        break;
    case Supply1Decl:
...
vl_gate_inst_list::copy()
{
    ...
    if (gates) {
        ...
        while (gen.next(&inst)) {
            ...
            if (newinst->name) {
                vl_module *current_mod =
                    vl_var::simulator->context->currentModule();
                if (current_mod) {
