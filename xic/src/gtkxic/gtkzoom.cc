 ...
 *                                                                        *
 *========================================================================*
 $Id: gtkzoom.cc,v 5.20 2016/03/02 00:39:41 stevew Exp $
 *========================================================================*/
...
void
sZm::action_proc(GtkWidget *caller)
{
...
void
sZm::zm_cancel_proc(GtkWidget*, void *client_data)
{
    sZm *zm = static_cast<sZm*>(client_data);
    if (zm)
        zm->popdown();
}
...
//
void
sZm::zm_action(GtkWidget *widget, void *client_data)
{
    sZm *zm = static_cast<sZm*>(client_data);
    if (zm)
