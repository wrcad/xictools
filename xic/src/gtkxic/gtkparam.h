 ...
 *                                                                        *
 *========================================================================*
 $Id: gtkparam.h,v 5.11 2013/04/10 03:45:41 stevew Exp $
 *========================================================================*/
...
#ifdef WIN32
    static void primary_get_cb(GtkClipboard*, GtkSelectionData*,
        unsigned int, void*);
    static void primary_clear_cb(GtkClipboard*, void*);
#endif
