...
void
cAsmPrg::update(const char *msg, ASMcode code)
{
...
// Static function.
void
cAsmPrg::prg_cancel_proc(GtkWidget*, void *arg)
{
    cAsmPrg *ptr = static_cast<cAsmPrg*>(arg);
    delete ptr;
}
...
// Static function.
void
cAsmPrg::prg_abort_proc(GtkWidget*, void *arg)
{
    cAsmPrg *ptr = static_cast<cAsmPrg*>(arg);
    ptr->prg_abort = true;
}
