...
// Static function.
void
cCflags::cf_cancel_proc(GtkWidget*, void*)
{
...
// Static function.
void
cCflags::cf_btn_proc(GtkWidget *caller, void*)
{
    if (!CF)
        return;
...
//
int
cCflags::cf_btn_hdlr(GtkWidget *caller, GdkEvent *event, void*)
{
    if (!CF)
        return (true);
