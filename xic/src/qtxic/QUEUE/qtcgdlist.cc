...
//
void
cCGDlist::action_hdlr(GtkWidget *caller, void *client_data)
{
...
//
int
cCGDlist::cgl_selection_proc(GtkTreeSelection*, GtkTreeModel *store,
...
//
bool
cCGDlist::cgl_focus_proc(GtkWidget*, GdkEvent*, void*)
{
    if (CGL) {
        GtkTreeSelection *sel =
...
//
void
cCGDlist::cgl_action_proc(GtkWidget *caller, void *client_data)
{
    if (CGL)
...
//
void
cCGDlist::cgl_cancel(GtkWidget*, void*)
{
