...
//-----------------------------------------------------------------------------
// The cAsmTf (instance transform entry) class

cAsmTf::cAsmTf(cAsmPage *src)
{
    tf_owner = src;
...
//
void
cAsmTf::set_sens(bool has_selection, bool has_toplev)
{
...
void
cAsmTf::get_tx_params(tlinfo *tl)
{
    if (!tl)
        return;
...
void
cAsmTf::set_tx_params(tlinfo *tl)
{
    if (!tl)
        return;
    int ndgt = CD()->numDigits();
...
//
void
cAsmTf::tf_angle_proc(GtkWidget *widget, void *mtxp)
{
    cAsmTf *tx = static_cast<cAsmTf*>(mtxp);
...
//
void
cAsmTf::tf_use_win_proc(GtkWidget*, void *mtxp)
{
    cAsmTf *tx = static_cast<cAsmTf*>(mtxp);
