...
//
void
cCHDlist::action_hdlr(GtkWidget *caller, void *client_data)
{
...
//
void
cCHDlist::chl_cancel(GtkWidget*, void*)
{
...
//
void
cCHDlist::chl_action_proc(GtkWidget *caller, void *client_data)
{
    if (CHL)
...
//
void
cCHDlist::chl_geom_proc(GtkWidget *caller, void*)
{
    if (!CHL)
        return;
...
//
int
cCHDlist::chl_selection_proc(GtkTreeSelection*, GtkTreeModel *store,
...
//
bool
cCHDlist::chl_focus_proc(GtkWidget*, GdkEvent*, void*)
{
    if (CHL) {
        GtkTreeSelection *sel =
