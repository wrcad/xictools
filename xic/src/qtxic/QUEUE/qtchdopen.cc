...
cCHDopen::cCHDopen(GRobject caller, bool(*callback)(const char*, const char*, int, void*),
...
//
void
cCHDopen::apply_proc(GtkWidget *widget)
{
    int ret = true;
...
// Static function.
void
cCHDopen::co_cancel_proc(GtkWidget*, void*)
{
    delete Co;
}
...
// Static function.
void
cCHDopen::co_action(GtkWidget *caller, void*)
{
    if (!Co)
        return;
...
// Private static GTK signal handler.
void
cCHDopen::co_info_proc(GtkWidget *caller, void*)
{
