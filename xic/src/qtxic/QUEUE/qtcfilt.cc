...
cCfilt::cCfilt(GRobject c, DisplayMode dm, void(*cb)(cfilter_t*, void*), void *arg)
{
    instPtr = this;
    cf_caller = c;
    cf_mode = dm;
...
// Static function.
void
cCfilt::cf_cancel_proc(GtkWidget*, void*)
{
...
// Static function.
void
cCfilt::cf_action(GtkWidget *caller, void*)
{
    if (!Cf)
        return;
...
// Static function.
void
cCfilt::cf_radio(GtkWidget *caller, void*)
{
    if (!Cf)
        return;
...
// Static function.
void
cCfilt::cf_sto_menu_proc(GtkWidget*, void *arg)
{
    if (!Cf)
        return;
    int ix = (intptr_t)arg;
...
// Static function.
void
cCfilt::cf_rcl_menu_proc(GtkWidget*, void *arg)
{
    if (!Cf)
        return;
    int ix = (intptr_t)arg;
