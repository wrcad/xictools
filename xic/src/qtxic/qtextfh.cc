...
cFH::PopUpExtIf(GRobject caller, ShowMode mode)
{
    ...
    QTdev::self()->SetPopupLocation(GRloc(LW_LR), cFHdlg::self(),
...
cFHdlg *cFHdlg::instPtr;

cFHdlg::cFHdlg(GRobject c)
{
    instPtr = this;
    fh_caller = c;
    fh_label = 0;
...
void
cFHdlg::update_label(const char *s)
{
...
//
void
cFHdlg::select_range(int start, int end)
{
    /*
    GtkTextBuffer *textbuf =
        gtk_text_view_get_buffer(GTK_TEXT_VIEW(fh_jobs));
...
// Static function.
void
cFHdlg::fh_cancel_proc(GtkWidget*, void*)
{
...
// Static function.
void
cFHdlg::fh_help_proc(GtkWidget*, void*)
{
...
// Static function.
void
cFHdlg::fh_change_proc(GtkWidget *widget, void *arg)
{
...
// Static function.
void
cFHdlg::fh_units_proc(GtkWidget *caller, void*)
{
...
// Static function.
void
cFHdlg::fh_p_cb(bool ok, void *arg)
{
    char *fname = (char*)arg;
    if (ok)
...
// Static function.
void
cFHdlg::fh_dump_cb(const char *fname, void *client_data)
{
...
// Static function.
void
cFHdlg::fh_btn_proc(GtkWidget *widget, void *arg)
{
    if (!Fh)
        return;
    const char *s;
...
// Static function.
int
cFHdlg::fh_button_dn(GtkWidget *caller, GdkEvent *event, void*)
{
    if (!Fh)
        return (true);
