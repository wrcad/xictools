 ...
 *                                                                        *
 *========================================================================*
 $Id: b3askm.cc,v 2.15 2015/07/26 01:09:10 stevew Exp $
 *========================================================================*/
...
int
BSIM3dev::askModl(const sGENmodel *genmod, int which, IFdata *data)
{
    const sBSIM3model *model = static_cast<const sBSIM3model*>(genmod);
    ...
    case  BSIM3_MOD_TNOM :
        /* SRW - see note in b3set.cc
                    value->rValue = model->BSIM3tnom;
        */
        value->rValue = model->BSIM3tnom - CONSTCtoK;
        return(OK);
    case BSIM3_MOD_CGSO:
