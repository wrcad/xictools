 ...
 *                                                                        *
 *========================================================================*
 $Id: b3setm.cc,v 2.15 2015/07/26 01:09:10 stevew Exp $
 *========================================================================*/
...
int
BSIM3dev::setModl(int param, IFdata *data, sGENmodel *genmod)
{
    sBSIM3model *mod = static_cast<sBSIM3model*>(genmod);
