 ...
 *                                                                        *
 *========================================================================*
 $Id: b4acld.cc,v 1.3 2011/12/18 01:15:30 stevew Exp $
 *========================================================================*/
...
// SRW
            if (here->BSIM4adjoint)
            {
                ...
                if (here->BSIM4rgateMod == 1)
                {
                    ...
                    *(adj->BSIM4GPgpPtr +1) += xcggbr;
                    *(adj->BSIM4GPgpPtr) += geltd + xcggbi + gIgtotg;
                    *(adj->BSIM4GPdpPtr +1) += xcgdbr;
                    *(adj->BSIM4GPdpPtr) += xcgdbi + gIgtotd;
                    *(adj->BSIM4GPspPtr +1) += xcgsbr;
                    *(adj->BSIM4GPspPtr) += xcgsbi + gIgtots;
                    *(adj->BSIM4GPbpPtr +1) += xcgbbr;
                    *(adj->BSIM4GPbpPtr) += xcgbbi + gIgtotb;
                } /* WDLiu: gcrg already subtracted from all gcrgg below */
                else if (here->BSIM4rgateMod == 2)
                {
                    ...
                    *(adj->BSIM4GPgpPtr +1) += xcggbr;
                    *(adj->BSIM4GPgpPtr) -= gcrgg - xcggbi - gIgtotg;
                    *(adj->BSIM4GPdpPtr +1) += xcgdbr;
                    *(adj->BSIM4GPdpPtr) -= gcrgd - xcgdbi - gIgtotd;
                    *(adj->BSIM4GPspPtr +1) += xcgsbr;
                    *(adj->BSIM4GPspPtr) -= gcrgs - xcgsbi - gIgtots;
                    *(adj->BSIM4GPbpPtr +1) += xcgbbr;
                    *(adj->BSIM4GPbpPtr) -= gcrgb - xcgbbi - gIgtotb;
                }
                else if (here->BSIM4rgateMod == 3)
                {
                    *(adj->BSIM4GEgePtr) += geltd;
                    ...
                    *(adj->BSIM4GMgmPtr) += geltd + gcrg;
                    *(adj->BSIM4GMgmPtr +1) += xcgmgmb;

                    *(adj->BSIM4GMdpPtr) += gcrgd;
                    *(adj->BSIM4GMdpPtr +1) += xcgmdb;
                    *(adj->BSIM4GMgpPtr) += gcrgg;
                    *(adj->BSIM4GMspPtr) += gcrgs;
                    *(adj->BSIM4GMspPtr +1) += xcgmsb;
                    *(adj->BSIM4GMbpPtr) += gcrgb;
                    *(adj->BSIM4GMbpPtr +1) += xcgmbb;

                    *(adj->BSIM4DPgmPtr +1) += xcdgmb;
                    *(adj->BSIM4GPgmPtr) -= gcrg;
                    *(adj->BSIM4SPgmPtr +1) += xcsgmb;
                    *(adj->BSIM4BPgmPtr +1) += xcbgmb;
                ...
                {
                    *(adj->BSIM4GPgpPtr +1) += xcggbr;
                    *(adj->BSIM4GPgpPtr) += xcggbi + gIgtotg;
                    *(adj->BSIM4GPdpPtr +1) += xcgdbr;
                    *(adj->BSIM4GPdpPtr) += xcgdbi + gIgtotd;
                    *(adj->BSIM4GPspPtr +1) += xcgsbr;
                    *(adj->BSIM4GPspPtr) += xcgsbi + gIgtots;
                ...
                *(adj->BSIM4DPdpPtr +1) += xcddbr + gdsi + RevSumi;
                *(adj->BSIM4DPdpPtr) += gdpr + xcddbi + gdsr + here->BSIM4gbd
                                        - gdtotd + RevSumr + gbdpdp - gIdtotd;
                *(adj->BSIM4DPdPtr) -= gdpr + gdtot;
                *(adj->BSIM4DPgpPtr +1) += xcdgbr + Gmi;
                *(adj->BSIM4DPgpPtr) += Gmr + xcdgbi - gdtotg + gbdpg - gIdtotg;
                *(adj->BSIM4DPspPtr +1) += xcdsbr - gdsi - FwdSumi;
                *(adj->BSIM4DPspPtr) -= gdsr - xcdsbi + FwdSumr + gdtots - gbdpsp + gIdtots;
                *(adj->BSIM4DPbpPtr +1) += xcdbbr + Gmbsi;
                *(adj->BSIM4DPbpPtr) -= gjbd + gdtotb - xcdbbi - Gmbsr - gbdpb + gIdtotb;

                *(adj->BSIM4DdpPtr) -= gdpr - gdtotd;
                *(adj->BSIM4DdPtr) += gdpr + gdtot;

                *(adj->BSIM4SPdpPtr +1) += xcsdbr - gdsi - RevSumi;
                *(adj->BSIM4SPdpPtr) -= gdsr - xcsdbi + gstotd + RevSumr - gbspdp + gIstotd;
                *(adj->BSIM4SPgpPtr +1) += xcsgbr - Gmi;
                *(adj->BSIM4SPgpPtr) -= Gmr - xcsgbi + gstotg - gbspg + gIstotg;
                *(adj->BSIM4SPspPtr +1) += xcssbr + gdsi + FwdSumi;
                *(adj->BSIM4SPspPtr) += gspr + xcssbi + gdsr + here->BSIM4gbs
                                        - gstots + FwdSumr + gbspsp - gIstots;
                *(adj->BSIM4SPsPtr) -= gspr + gstot;
                *(adj->BSIM4SPbpPtr +1) += xcsbbr - Gmbsi;
                *(adj->BSIM4SPbpPtr) -= gjbs + gstotb - xcsbbi + Gmbsr - gbspb + gIstotb;

                *(adj->BSIM4SspPtr) -= gspr - gstots;
                *(adj->BSIM4SsPtr) += gspr + gstot;

                *(adj->BSIM4BPdpPtr +1) += xcbdb;
                *(adj->BSIM4BPdpPtr) -= gjbd - gbbdp + gIbtotd;
                *(adj->BSIM4BPgpPtr +1) += xcbgb;
                *(adj->BSIM4BPgpPtr) -= here->BSIM4gbgs + gIbtotg;
                *(adj->BSIM4BPspPtr +1) += xcbsb;
                *(adj->BSIM4BPspPtr) -= gjbs - gbbsp + gIbtots;
                *(adj->BSIM4BPbpPtr +1) += xcbbb;
                *(adj->BSIM4BPbpPtr) += gjbd + gjbs - here->BSIM4gbbs
                                        - gIbtotb;
                ggidld = here->BSIM4ggidld;
                ggidlg = here->BSIM4ggidlg;
                ggidlb = here->BSIM4ggidlb;
                ...
                if (here->BSIM4rbodyMod)
                {
                    (*(adj->BSIM4DPdbPtr +1) += xcdbdb);
                    (*(adj->BSIM4DPdbPtr) -= here->BSIM4gbd);
                    (*(adj->BSIM4SPsbPtr +1) += xcsbsb);
                    (*(adj->BSIM4SPsbPtr) -= here->BSIM4gbs);

                    (*(adj->BSIM4DBdpPtr +1) += xcdbdb);
                    (*(adj->BSIM4DBdpPtr) -= here->BSIM4gbd);
                    (*(adj->BSIM4DBdbPtr +1) -= xcdbdb);
                    (*(adj->BSIM4DBdbPtr) += here->BSIM4gbd + here->BSIM4grbpd
                                             + here->BSIM4grbdb);
                    ...
                    (*(adj->BSIM4SBspPtr +1) += xcsbsb);
                    (*(adj->BSIM4SBspPtr) -= here->BSIM4gbs);
                    (*(adj->BSIM4SBbpPtr) -= here->BSIM4grbps);
                    (*(adj->BSIM4SBbPtr) -= here->BSIM4grbsb);
                    (*(adj->BSIM4SBsbPtr +1) -= xcsbsb);
                    (*(adj->BSIM4SBsbPtr) += here->BSIM4gbs
                                             + here->BSIM4grbps + here->BSIM4grbsb);
                ...
                /*
                 * WDLiu: The internal charge node generated for transient NQS is no>
                 *        AC NQS. The following is not doing a real job, but we have>
                 *        otherwise a singular AC NQS matrix may occur if the transi>
                 *        The charge node is isolated from the instance.
                 */
                if (here->BSIM4trnqsMod)
                {
