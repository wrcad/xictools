 ...
 *                                                                        *
 *========================================================================*
 $Id: b4temp.cc,v 1.6 2011/12/18 01:15:30 stevew Exp $
 *========================================================================*/
    ...
    for (; model != NULL; model = model->BSIM4nextModel)
    {
                ...
                here = here->BSIM4nextInstance)
        {
            ...
            if (BSIM4checkModel(model, here, ckt))
            {
                ...
                /* SRW
                                  (*(SPfrontEnd->IFerror)) (ERR_FATAL,
                                  "Fatal error(s) detected during BSIM4.3.0 parameter checking for %s in model %s",
                                  namarray);
                */
                DVO.textOut(OUT_FATAL,
                         "Fatal error(s) detected during BSIM4.3.0 parameter checking for %s in model %s",
