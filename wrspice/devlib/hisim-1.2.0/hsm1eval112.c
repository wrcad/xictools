/***********************************************************************
 ...
 VERSION : HiSIM 1.2.0
 FILE : hsm1eval112.c of HiSIM 1.2.0
...
*-----------------*/
   ...
   if ( Pslk > Psdl ){
	 ...
	 Cqyd = ( ( Ps0_dVds + 1.0e0 - T1_dVds ) / sIN.xqy ) * T2 ;
	 if ( Cqyd < 0.0e0 ) Cqyd = 0.0 ;
	 Cqyg = ( ( Ps0_dVgs  - T1_dVgs ) / sIN.xqy ) * T2 ;
	 Cqyb = ( ( Ps0_dVbs  - T1_dVbs ) / sIN.xqy ) * T2 ;
	 Cqys = - ( Cqyb +  Cqyd + Cqyg ) ;
    }
