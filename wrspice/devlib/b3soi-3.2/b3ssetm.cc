 ...
 *                                                                        *
 *========================================================================*
 $Id: b3ssetm.cc,v 1.3 2015/07/26 01:09:09 stevew Exp $
 *========================================================================*/
...
int
B3SOIdev::setModl(int param, IFdata *data, sGENmodel *genmod)
{
    sB3SOImodel *mod = static_cast<sB3SOImodel*>(genmod);
    ...
    case  B3SOI_MOD_TOXM :
        mod->B3SOItoxm = value->rValue;
        mod->B3SOItoxmGiven = TRUE;
        break; /* v3.2 */
    ...
    case  B3SOI_MOD_SOIMOD:
        mod->B3SOIsoiMod = value->iValue;
        mod->B3SOIsoiModGiven = TRUE;
        break; /* v3.2 bug fix */
    case  B3SOI_MOD_VBS0PD:
        mod->B3SOIvbs0pd = value->rValue;
        mod->B3SOIvbs0pdGiven = TRUE;
        break; /* v3.2 */
    case  B3SOI_MOD_VBS0FD:
        mod->B3SOIvbs0fd = value->rValue;
        mod->B3SOIvbs0fdGiven = TRUE;
        break; /* v3.2 */
    case  B3SOI_MOD_VBSA:
    ...
    case B3SOI_MOD_RGATEMOD :
        mod->B3SOIrgateMod = value->iValue;
        mod->B3SOIrgateModGiven = TRUE;
        break;
    case B3SOI_MOD_XRCRG1 :
        mod->B3SOIxrcrg1 = value->rValue;
        mod->B3SOIxrcrg1Given = TRUE;
        break;
    case B3SOI_MOD_XRCRG2 :
        mod->B3SOIxrcrg2 = value->rValue;
        mod->B3SOIxrcrg2Given = TRUE;
        break;
    case B3SOI_MOD_RSHG :
        mod->B3SOIrshg = value->rValue;
        mod->B3SOIrshgGiven = TRUE;
        break;
    case B3SOI_MOD_NGCON :
        mod->B3SOIngcon = value->rValue;
        mod->B3SOIngconGiven = TRUE;
        break;
    case  B3SOI_MOD_XGW :
        mod->B3SOIxgw = value->rValue;
        mod->B3SOIxgwGiven = TRUE;
        break;
    case  B3SOI_MOD_XGL :
        mod->B3SOIxgl = value->rValue;
        mod->B3SOIxglGiven = TRUE;
        break;
        /* v3.1 wanh added RF end */

        /* v3.2 */
    case B3SOI_MOD_FNOIMOD :
        mod->B3SOIfnoiMod = value->iValue;
        mod->B3SOIfnoiModGiven = TRUE;
        break;
    case B3SOI_MOD_TNOIMOD :
        mod->B3SOItnoiMod = value->iValue;
        mod->B3SOItnoiModGiven = TRUE;
        break;
    case  B3SOI_MOD_TNOIA :
        mod->B3SOItnoia = value->rValue;
        mod->B3SOItnoiaGiven = TRUE;
        break;
    case  B3SOI_MOD_TNOIB :
        mod->B3SOItnoib = value->rValue;
        mod->B3SOItnoibGiven = TRUE;
        break;
    case  B3SOI_MOD_RNOIA :
        mod->B3SOIrnoia = value->rValue;
        mod->B3SOIrnoiaGiven = TRUE;
        break;
    case  B3SOI_MOD_RNOIB :
        mod->B3SOIrnoib = value->rValue;
        mod->B3SOIrnoibGiven = TRUE;
        break;
    case  B3SOI_MOD_NTNOI :
        mod->B3SOIntnoi = value->rValue;
        mod->B3SOIntnoiGiven = TRUE;
        break;
    ...
    case  B3SOI_MOD_MOIN :
        ...
        break;
    case  B3SOI_MOD_NOFF :
        mod->B3SOInoff = value->rValue;
        mod->B3SOInoffGiven = TRUE;
        break; /* v3.2 */
    ...
    case  B3SOI_MOD_DLBG :
        ...
        /* v3.1 */
    case  B3SOI_MOD_LXJ :
        mod->B3SOIlxj = value->rValue;
        mod->B3SOIlxjGiven = TRUE;
        break;
    case  B3SOI_MOD_LALPHAGB1 :
        mod->B3SOIlalphaGB1 = value->rValue;
        mod->B3SOIlalphaGB1Given = TRUE;
        break;
    case  B3SOI_MOD_LALPHAGB2 :
        mod->B3SOIlalphaGB2 = value->rValue;
        mod->B3SOIlalphaGB2Given = TRUE;
        break;
    case  B3SOI_MOD_LBETAGB1 :
        mod->B3SOIlbetaGB1 = value->rValue;
        mod->B3SOIlbetaGB1Given = TRUE;
        break;
    case  B3SOI_MOD_LBETAGB2 :
        mod->B3SOIlbetaGB2 = value->rValue;
        mod->B3SOIlbetaGB2Given = TRUE;
        break;
    case  B3SOI_MOD_LNDIF :
        mod->B3SOIlndif = value->rValue;
        mod->B3SOIlndifGiven = TRUE;
        break;
    case  B3SOI_MOD_LNTRECF :
        mod->B3SOIlntrecf = value->rValue;
        mod->B3SOIlntrecfGiven = TRUE;
        break;
    case  B3SOI_MOD_LNTRECR :
        mod->B3SOIlntrecr = value->rValue;
        mod->B3SOIlntrecrGiven = TRUE;
        break;
    case  B3SOI_MOD_LXBJT :
        mod->B3SOIlxbjt = value->rValue;
        mod->B3SOIlxbjtGiven = TRUE;
        break;
    case  B3SOI_MOD_LXDIF :
        mod->B3SOIlxdif = value->rValue;
        mod->B3SOIlxdifGiven = TRUE;
        break;
    case  B3SOI_MOD_LXREC :
        mod->B3SOIlxrec = value->rValue;
        mod->B3SOIlxrecGiven = TRUE;
        break;
    case  B3SOI_MOD_LXTUN :
        mod->B3SOIlxtun = value->rValue;
        mod->B3SOIlxtunGiven = TRUE;
        break;
    case  B3SOI_MOD_LCGDL :
        mod->B3SOIlcgdl = value->rValue;
        mod->B3SOIlcgdlGiven = TRUE;
        break;
    case  B3SOI_MOD_LCGSL :
        mod->B3SOIlcgsl = value->rValue;
        mod->B3SOIlcgslGiven = TRUE;
        break;
    case  B3SOI_MOD_LCKAPPA :
        mod->B3SOIlckappa = value->rValue;
        mod->B3SOIlckappaGiven = TRUE;
        break;
    case  B3SOI_MOD_LUTE :
        mod->B3SOIlute = value->rValue;
        mod->B3SOIluteGiven = TRUE;
        break;
    case  B3SOI_MOD_LKT1 :
        mod->B3SOIlkt1 = value->rValue;
        mod->B3SOIlkt1Given = TRUE;
        break;
    case  B3SOI_MOD_LKT2 :
        mod->B3SOIlkt2 = value->rValue;
        mod->B3SOIlkt2Given = TRUE;
        break;
    case  B3SOI_MOD_LKT1L :
        mod->B3SOIlkt1l = value->rValue;
        mod->B3SOIlkt1lGiven = TRUE;
        break;
    case  B3SOI_MOD_LUA1 :
        mod->B3SOIlua1 = value->rValue;
        mod->B3SOIlua1Given = TRUE;
        break;
    case  B3SOI_MOD_LUB1 :
        mod->B3SOIlub1 = value->rValue;
        mod->B3SOIlub1Given = TRUE;
        break;
    case  B3SOI_MOD_LUC1 :
        mod->B3SOIluc1 = value->rValue;
        mod->B3SOIluc1Given = TRUE;
        break;
    case  B3SOI_MOD_LAT :
        mod->B3SOIlat = value->rValue;
        mod->B3SOIlatGiven = TRUE;
        break;
    case  B3SOI_MOD_LPRT :
        mod->B3SOIlprt = value->rValue;
        mod->B3SOIlprtGiven = TRUE;
        break;
    ...
    case  B3SOI_MOD_LAHLI :
        ...
        /* v3.1 wanh added for RF */
    case B3SOI_MOD_LXRCRG1 :
        mod->B3SOIlxrcrg1 = value->rValue;
        mod->B3SOIlxrcrg1Given = TRUE;
        break;
    case B3SOI_MOD_LXRCRG2 :
        mod->B3SOIlxrcrg2 = value->rValue;
        mod->B3SOIlxrcrg2Given = TRUE;
        break;
    ...
    case  B3SOI_MOD_LNOFF :
        mod->B3SOIlnoff = value->rValue;
        mod->B3SOIlnoffGiven = TRUE;
        break; /* v3.2 */

        /* Width Dependence */
        /* v3.1 */
    case  B3SOI_MOD_WXJ :
        mod->B3SOIwxj = value->rValue;
        mod->B3SOIwxjGiven = TRUE;
        break;
    case  B3SOI_MOD_WALPHAGB1 :
        mod->B3SOIwalphaGB1 = value->rValue;
        mod->B3SOIwalphaGB1Given = TRUE;
        break;
    case  B3SOI_MOD_WALPHAGB2 :
        mod->B3SOIwalphaGB2 = value->rValue;
        mod->B3SOIwalphaGB2Given = TRUE;
        break;
    case  B3SOI_MOD_WBETAGB1 :
        mod->B3SOIwbetaGB1 = value->rValue;
        mod->B3SOIwbetaGB1Given = TRUE;
        break;
    case  B3SOI_MOD_WBETAGB2 :
        mod->B3SOIwbetaGB2 = value->rValue;
        mod->B3SOIwbetaGB2Given = TRUE;
        break;
    case  B3SOI_MOD_WNDIF :
        mod->B3SOIwndif = value->rValue;
        mod->B3SOIwndifGiven = TRUE;
        break;
    case  B3SOI_MOD_WNTRECF :
        mod->B3SOIwntrecf = value->rValue;
        mod->B3SOIwntrecfGiven = TRUE;
        break;
    case  B3SOI_MOD_WNTRECR :
        mod->B3SOIwntrecr = value->rValue;
        mod->B3SOIwntrecrGiven = TRUE;
        break;
    case  B3SOI_MOD_WXBJT :
        mod->B3SOIwxbjt = value->rValue;
        mod->B3SOIwxbjtGiven = TRUE;
        break;
    case  B3SOI_MOD_WXDIF :
        mod->B3SOIwxdif = value->rValue;
        mod->B3SOIwxdifGiven = TRUE;
        break;
    case  B3SOI_MOD_WXREC :
        mod->B3SOIwxrec = value->rValue;
        mod->B3SOIwxrecGiven = TRUE;
        break;
    case  B3SOI_MOD_WXTUN :
        mod->B3SOIwxtun = value->rValue;
        mod->B3SOIwxtunGiven = TRUE;
        break;
    case  B3SOI_MOD_WCGDL :
        mod->B3SOIwcgdl = value->rValue;
        mod->B3SOIwcgdlGiven = TRUE;
        break;
    case  B3SOI_MOD_WCGSL :
        mod->B3SOIwcgsl = value->rValue;
        mod->B3SOIwcgslGiven = TRUE;
        break;
    case  B3SOI_MOD_WCKAPPA :
        mod->B3SOIwckappa = value->rValue;
        mod->B3SOIwckappaGiven = TRUE;
        break;
    case  B3SOI_MOD_WUTE :
        mod->B3SOIwute = value->rValue;
        mod->B3SOIwuteGiven = TRUE;
        break;
    case  B3SOI_MOD_WKT1 :
        mod->B3SOIwkt1 = value->rValue;
        mod->B3SOIwkt1Given = TRUE;
        break;
    case  B3SOI_MOD_WKT2 :
        mod->B3SOIwkt2 = value->rValue;
        mod->B3SOIwkt2Given = TRUE;
        break;
    case  B3SOI_MOD_WKT1L :
        mod->B3SOIwkt1l = value->rValue;
        mod->B3SOIwkt1lGiven = TRUE;
        break;
    case  B3SOI_MOD_WUA1 :
        mod->B3SOIwua1 = value->rValue;
        mod->B3SOIwua1Given = TRUE;
        break;
    case  B3SOI_MOD_WUB1 :
        mod->B3SOIwub1 = value->rValue;
        mod->B3SOIwub1Given = TRUE;
        break;
    case  B3SOI_MOD_WUC1 :
        mod->B3SOIwuc1 = value->rValue;
        mod->B3SOIwuc1Given = TRUE;
        break;
    case  B3SOI_MOD_WAT :
        mod->B3SOIwat = value->rValue;
        mod->B3SOIwatGiven = TRUE;
        break;
    case  B3SOI_MOD_WPRT :
        mod->B3SOIwprt = value->rValue;
        mod->B3SOIwprtGiven = TRUE;
        break;
    ...
    case  B3SOI_MOD_WAHLI :
        ...
        /* v3.1 wanh added for RF */
    case B3SOI_MOD_WXRCRG1 :
        mod->B3SOIwxrcrg1 = value->rValue;
        mod->B3SOIwxrcrg1Given = TRUE;
        break;
    case B3SOI_MOD_WXRCRG2 :
        mod->B3SOIwxrcrg2 = value->rValue;
        mod->B3SOIwxrcrg2Given = TRUE;
        break;
        /* v3.1 wanh added for RF end */
    ...
    case  B3SOI_MOD_WNOFF :
        mod->B3SOIwnoff = value->rValue;
        mod->B3SOIwnoffGiven = TRUE;
        break; /* v3.2 */

        /* Cross-term Dependence */
        /* v3.1 */
    case  B3SOI_MOD_PXJ :
        mod->B3SOIpxj = value->rValue;
        mod->B3SOIpxjGiven = TRUE;
        break;
    case  B3SOI_MOD_PALPHAGB1 :
        mod->B3SOIpalphaGB1 = value->rValue;
        mod->B3SOIpalphaGB1Given = TRUE;
        break;
    case  B3SOI_MOD_PALPHAGB2 :
        mod->B3SOIpalphaGB2 = value->rValue;
        mod->B3SOIpalphaGB2Given = TRUE;
        break;
    case  B3SOI_MOD_PBETAGB1 :
        mod->B3SOIpbetaGB1 = value->rValue;
        mod->B3SOIpbetaGB1Given = TRUE;
        break;
    case  B3SOI_MOD_PBETAGB2 :
        mod->B3SOIpbetaGB2 = value->rValue;
        mod->B3SOIpbetaGB2Given = TRUE;
        break;
    case  B3SOI_MOD_PNDIF :
        mod->B3SOIpndif = value->rValue;
        mod->B3SOIpndifGiven = TRUE;
        break;
    case  B3SOI_MOD_PNTRECF :
        mod->B3SOIpntrecf = value->rValue;
        mod->B3SOIpntrecfGiven = TRUE;
        break;
    case  B3SOI_MOD_PNTRECR :
        mod->B3SOIpntrecr = value->rValue;
        mod->B3SOIpntrecrGiven = TRUE;
        break;
    case  B3SOI_MOD_PXBJT :
        mod->B3SOIpxbjt = value->rValue;
        mod->B3SOIpxbjtGiven = TRUE;
        break;
    case  B3SOI_MOD_PXDIF :
        mod->B3SOIpxdif = value->rValue;
        mod->B3SOIpxdifGiven = TRUE;
        break;
    case  B3SOI_MOD_PXREC :
        mod->B3SOIpxrec = value->rValue;
        mod->B3SOIpxrecGiven = TRUE;
        break;
    case  B3SOI_MOD_PXTUN :
        mod->B3SOIpxtun = value->rValue;
        mod->B3SOIpxtunGiven = TRUE;
        break;
    case  B3SOI_MOD_PCGDL :
        mod->B3SOIpcgdl = value->rValue;
        mod->B3SOIpcgdlGiven = TRUE;
        break;
    case  B3SOI_MOD_PCGSL :
        mod->B3SOIpcgsl = value->rValue;
        mod->B3SOIpcgslGiven = TRUE;
        break;
    case  B3SOI_MOD_PCKAPPA :
        mod->B3SOIpckappa = value->rValue;
        mod->B3SOIpckappaGiven = TRUE;
        break;
    case  B3SOI_MOD_PUTE :
        mod->B3SOIpute = value->rValue;
        mod->B3SOIputeGiven = TRUE;
        break;
    case  B3SOI_MOD_PKT1 :
        mod->B3SOIpkt1 = value->rValue;
        mod->B3SOIpkt1Given = TRUE;
        break;
    case  B3SOI_MOD_PKT2 :
        mod->B3SOIpkt2 = value->rValue;
        mod->B3SOIpkt2Given = TRUE;
        break;
    case  B3SOI_MOD_PKT1L :
        mod->B3SOIpkt1l = value->rValue;
        mod->B3SOIpkt1lGiven = TRUE;
        break;
    case  B3SOI_MOD_PUA1 :
        mod->B3SOIpua1 = value->rValue;
        mod->B3SOIpua1Given = TRUE;
        break;
    case  B3SOI_MOD_PUB1 :
        mod->B3SOIpub1 = value->rValue;
        mod->B3SOIpub1Given = TRUE;
        break;
    case  B3SOI_MOD_PUC1 :
        mod->B3SOIpuc1 = value->rValue;
        mod->B3SOIpuc1Given = TRUE;
        break;
    case  B3SOI_MOD_PAT :
        mod->B3SOIpat = value->rValue;
        mod->B3SOIpatGiven = TRUE;
        break;
    case  B3SOI_MOD_PPRT :
        mod->B3SOIpprt = value->rValue;
        mod->B3SOIpprtGiven = TRUE;
        break;
    ...
    case  B3SOI_MOD_PAHLI :
        ...
        /* v3.1 wanh added for RF */
    case B3SOI_MOD_PXRCRG1 :
        mod->B3SOIpxrcrg1 = value->rValue;
        mod->B3SOIpxrcrg1Given = TRUE;
        break;
    case B3SOI_MOD_PXRCRG2 :
        mod->B3SOIpxrcrg2 = value->rValue;
        mod->B3SOIpxrcrg2Given = TRUE;
        break;
        /* v3.1 wanh added for RF end */
    ...
    case  B3SOI_MOD_PNOFF :
        mod->B3SOIpnoff = value->rValue;
        mod->B3SOIpnoffGiven = TRUE;
        break; /* v3.2 */
