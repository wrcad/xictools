 ...
 *                                                                        *
 *========================================================================*
 $Id: soi3nois.cc,v 2.14 2015/08/08 01:51:10 stevew Exp $
 *========================================================================*/
...
int
SOI3dev::noise(int mode, int operation, sGENmodel *genmod, sCKT *ckt,
    sNdata *data, double *OnDens)
{
    sSOI3model *firstModel = static_cast<sSOI3model*>(genmod), *model;
    sSOI3instance *inst;

    char soi3name[N_MXVLNTH];
    double tempOnoise;
    double tempInoise;
...
//    int error;
    ...
    /* NTL modification change names - remove '_' prefix */
    static const char *SOI3nNames[SOI3NSRCS] = {            /* Note that we have to keep the order */
	"rd",              /* noise due to rd */        /* consistent with the index definitions */
	"rs",              /* noise due to rs */        /* in SOI3defs.h */
	"id",              /* noise due to id */
