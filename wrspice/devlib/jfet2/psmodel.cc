...
double *Gds;
*/
PSids(sCKT *ckt, sJFET2model *model, sJFET2instance *here, double vgs,
    double vgd, double *igs, double *igd, double *ggs, double *ggd,
...
*/
qgg(double vgs, double vgd, double gamma, double pb, double alpha, double vto,
    double vmax, double xc, double cgso, double cgdo, double *cgs, double *cgd)
{
...
double *capgd;
*/
PScharge(sCKT *ckt, sJFET2model *model, sJFET2instance *here, double vgs,
    double vgd, double *capgs, double *capgd)
{
...
double *xGds;
*/
PSacload(sCKT*, sJFET2model *model, sJFET2instance *here, double vgs,
    double vgd, double ids, double omega, double *Gm, double *xGm,
    double *Gds, double *xGds)
{
    double arg;
    double vds = vgs - vgd;
    double LFgam = LFGAM;
...
inst *here;
*/
PSinstanceinit(sJFET2model *model, sJFET2instance *here)
{
