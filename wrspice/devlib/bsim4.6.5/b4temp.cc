 ...
 *                                                                        *
 *========================================================================*
 $Id: b4temp.cc,v 1.5 2011/12/18 01:15:35 stevew Exp $
 *========================================================================*/
...
#define BSIM4checkModel checkModel
...
namespace
{
    int BSIM4DioIjthVjmEval(double Nvtm, double Ijth, double Isb, double XExpBV,
                            double *Vjm)
    {
...
int
BSIM4dev::temperature(sGENmodel *genmod, sCKT *ckt)
{
    ...
    for (; model != NULL; model = model->BSIM4nextModel)
    {
                ...
                here = here->BSIM4nextInstance)
        {
            ...
            if (Size_Not_Found)
            {
// SRW            pParam = (struct bsim4SizeDependParam *)malloc(
// SRW                            sizeof(struct bsim4SizeDependParam));
            ...
            if (model->BSIM4wpemod)
            {
                ...
                {
                    T3 = 0.0;
// SRW - bug was here, original code missing argument for %g
                    fprintf(stderr,
            ...
            */
            ...
            if (here->BSIM4sourcePerimeterGiven)
            {
                ...
                else
                {
                    if (model->BSIM4perMod == 0)
                        ...
                        here->BSIM4Pseff = here->BSIM4sourcePerimeter - pParam->BSIM4weffCJ * here->BSIM4nf;
                }
            }
            /* */
            ...
            {
                PAeffGeo(here->BSIM4nf, here->BSIM4geoMod, here->BSIM4min,
            ...
            if (here->BSIM4drainPerimeterGiven)
            {
                ...
                else
                {
                    if (model->BSIM4perMod == 0)
                        ...
                        here->BSIM4Pdeff = here->BSIM4drainPerimeter - pParam->BSIM4weffCJ * here->BSIM4nf;
                }
            }
            /* */
            ...
            */
            ...
            if (BSIM4checkModel(model, here, ckt))
            {
                ...
                */
                DVO.textOut(OUT_FATAL,
                         "Fatal error(s) detected during BSIM4.6.1 parameter checking for %s in model %s",
                         namarray[0], namarray[1]);
                return(E_BADPARM);
            }
        } /* End instance */
