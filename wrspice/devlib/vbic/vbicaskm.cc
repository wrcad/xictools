 ...
 *                                                                        *
 *========================================================================*
 $Id: vbicaskm.cc,v 1.2 2015/07/26 01:09:14 stevew Exp $
 *========================================================================*/
...
int
VBICdev::askModl(const sGENmodel *genmod, int which, IFdata *data)
{
    const sVBICmodel *here = static_cast<const sVBICmodel*>(genmod);
