 ...
 *                                                                        *
 *========================================================================*
 $Id: vbicsetm.cc,v 1.2 2015/07/26 01:09:14 stevew Exp $
 *========================================================================*/
...
//
int
VBICdev::setModl(int param, IFdata *data, sGENmodel *genmod)
{
    sVBICmodel *mods = static_cast<sVBICmodel*>(genmod);
