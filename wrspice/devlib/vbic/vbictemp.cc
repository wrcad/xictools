 ...
 *                                                                        *
 *========================================================================*
 $Id: vbictemp.cc,v 1.2 2015/07/30 18:16:29 stevew Exp $
 *========================================================================*/
...
#define VBICmodName GENmodName
#define VBICname GENname

static int vbic_4T_it_cf_t(double *p, double *pnom, double *TAMB);

int
VBICdev::temperature(sGENmodel *genmod, sCKT *ckt)
{
...
//SRW            iret = vbic_4T_it_cf_t(p,pnom,&TAMB);
