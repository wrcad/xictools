 ...
 *                                                                        *
 *========================================================================*
 $Id: b4sload.cc,v 1.10 2015/06/11 01:12:29 stevew Exp $
 *========================================================================*/
...
// See the file "BugReport" in the bsimsoi-4.3 docs directory.  The
// supplied code for this model has convergence problems that appear
// to be triggered by use of the bypass code.  Thus, NOBYPASS is
// defined here to disable the bypass code (bypassing is used by
// default in Spice3 and WRspice).
//
#define NOBYPASS
