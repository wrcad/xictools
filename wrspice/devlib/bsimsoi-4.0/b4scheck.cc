 ...
 *                                                                        *
 *========================================================================*
 $Id: b4scheck.cc,v 1.7 2011/12/18 01:15:39 stevew Exp $
 *========================================================================*/
...
//    if ((fplog = fopen("b4soiv1check.log", "w")) != NULL)
    {
        pParam = here->pParam;
// SRW
        ChkFprintf(fplog, "BSIMSOI-4.0 Parameter Check\n");
        ChkFprintf(fplog, "Model = %s\n", (const char*)model->B4SOImodName);
...
// SRW
            {
                ChkFprintf(fplog, "Warning: capMod < 2 is not supported by BSIMSOI-4.0.\n");
                WarnPrintf("capMod < 2 is not supported by BSIMSOI-4.0.\n");
            }
