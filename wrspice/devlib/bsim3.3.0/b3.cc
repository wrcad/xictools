 ...
 *                                                                        *
 *========================================================================*
 $Id: b3.cc,v 1.13 2016/09/26 01:47:35 stevew Exp $
 *========================================================================*/
...
IO("acnqsmod",          BSIM3_ACNQSMOD,     IF_INTEGER,
...
IO("acnqsmod",          BSIM3_MOD_ACNQSMOD, IF_INTEGER,
                "AC NQS model selector"),
...
IO("lintnoi",           BSIM3_MOD_LINTNOI,  IF_REAL,
...
{
    dv_name = "BSIM3.3.0";
    dv_description = "Berkeley Short Channel MOSFET Model BSIM3.3.0";

    dv_numKeys = NUMELEMS(BSIM3keys);
    dv_keys = BSIM3keys;

    dv_levels[0] = 9;
    dv_levels[1] = 53;  // HSPICE compatability
    dv_levels[2] = 0;
