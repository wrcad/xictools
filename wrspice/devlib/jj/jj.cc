...
IO("temp",              JJ_TEMP,            IF_REAL|IF_TEMP,
...
IO("tc",                JJ_MOD_TC,          IF_REAL|IF_TEMP,
                "Superconducting transition temperature Kelvin"),
IO("tnom",              JJ_MOD_TNOM,        IF_REAL|IF_TEMP,
                "Parameter measurement temperature Kelvin"),
IO("temp",              JJ_MOD_TEMP,        IF_REAL|IF_TEMP,
                "Operating temperature Kelvin"),
...
IO("force",             JJ_MOD_FORCE,       IF_FLAG,
                "No limits imposed for rsub, rnorm"),
#ifdef NEWLSH
