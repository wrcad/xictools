 ...
 *                                                                        *
 *========================================================================*
 $Id: b4aski.cc,v 2.11 2015/07/26 01:09:10 stevew Exp $
 *========================================================================*/
...
//            value->rValue = *(ckt->CKTstate0 + here->BSIM4qb);
        value->rValue = ckt->interp(here->BSIM4qb);
        return(OK);
    case BSIM4_CQB:
...
//            value->rValue = *(ckt->CKTstate0 + here->BSIM4qg);
        value->rValue = ckt->interp(here->BSIM4qg);
        return(OK);
    case BSIM4_CQG:
...
//            value->rValue = *(ckt->CKTstate0 + here->BSIM4qd);
        value->rValue = ckt->interp(here->BSIM4qd);
        return(OK);
    case BSIM4_CQD:
...
//            value->rValue = *(ckt->CKTstate0 + here->BSIM4qs);
        value->rValue = ckt->interp(here->BSIM4qs);
        return(OK);
    case BSIM4_CGGB:
