 ...
 *                                                                        *
 *========================================================================*
 $Id: b3sdefs.h,v 2.25 2016/09/26 01:47:20 stevew Exp $
 *========================================================================*/
...
struct sB3SOIinstance : public sGENinstance
{
    ...
    int B3SOIdNode;     // drain node
    int B3SOIgNode;     // gate node
    int B3SOIsNode;     // source node
    int B3SOIeNode;     // substrate node
    int B3SOIpNode;     // external body node
    int B3SOIbNode;     // internal body node
    int B3SOItempNode;  // temperature node
...
#define B3SOIa_cd      GENstate + 25
#define B3SOIa_cbs     GENstate + 26
#define B3SOIa_cbd     GENstate + 27
#define B3SOIa_gm      GENstate + 28
#define B3SOIa_gds     GENstate + 29
#define B3SOIa_gmbs    GENstate + 30
#define B3SOIa_gbd     GENstate + 31
#define B3SOIa_gbs     GENstate + 32
#define B3SOIa_cggb    GENstate + 33
#define B3SOIa_cgdb    GENstate + 34
#define B3SOIa_cgsb    GENstate + 35
#define B3SOIa_cdgb    GENstate + 36
#define B3SOIa_cddb    GENstate + 37
#define B3SOIa_cdsb    GENstate + 38
#define B3SOIa_cbgb    GENstate + 39
#define B3SOIa_cbdb    GENstate + 40
#define B3SOIa_cbsb    GENstate + 41
#define B3SOIa_von     GENstate + 42
#define B3SOIa_vdsat   GENstate + 43

#define B3SOIa_id      GENstate + 43
#define B3SOIa_is      GENstate + 44
#define B3SOIa_ig      GENstate + 45
#define B3SOIa_ib      GENstate + 46
#define B3SOIa_ie      GENstate + 47

#define B3SOInumStates 48
