...
IO("del1nom",           TJM_MQUEST_DEL1NOM, IF_REAL|IF_VOLT,
                "Side 1 delta at tnom"),
IO("del2nom",           TJM_MQUEST_DEL2NOM, IF_REAL|IF_VOLT,
                "Side 2 delta at tnom"),
IO("vgapnom",           TJM_MQUEST_VGAPNOM, IF_REAL|IF_VOLT,
                "Gap voltage at tnom"),
};
