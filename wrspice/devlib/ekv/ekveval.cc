 ...
 *                                                                        *
 *========================================================================*
 $Id: ekveval.cc,v 2.10 2008/09/22 02:47:07 stevew Exp $
 *========================================================================*/
...
/*************************************************************************/
void F_v_simple(double v, double *i_v, double *sqrt_i_v, double *d_i_v)
/* SRW
void F_v_simple(v, i_v, sqrt_i_v, d_i_v)

double v;
double *i_v, *sqrt_i_v, *d_i_v;
*/
...
/*************************************************************************/
void F_v_n(double v, double *i_v, double *sqrt_i_v, double *d_i_v)
/* SRW
void F_v_n(v, i_v, sqrt_i_v, d_i_v)
...
void
EKVevaluate(double vds, double vbs, double vgs, sEKVinstance *here,
    sEKVmodel *model, double *vonPointer, double *vdsatPointer, sCKT*)
/* SRW
void
EKVevaluate(vds,vbs,vgs,here,model,
vonPointer,vdsatPointer,ckt)
...

{
	...
	double /*deltaV,*/ deltaL;          /*  channel length reduction         */
	...
	double /*dGAMMAprime_factor,*/ dGAMMAprime_dVD, dGAMMAprime_dVS, dGAMMAprime_dVG;
	double /*dVP_factor,*/ dVP_dVD, dVP_dVG, dVP_dVS;
	double /*dVPprime_factor,*/ dVPprime_dVD, dVPprime_dVG, dVPprime_dVS;
