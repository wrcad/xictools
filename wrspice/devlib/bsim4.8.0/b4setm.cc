 ...
 *                                                                        *
 *========================================================================*
 $Id: b4setm.cc,v 1.3 2015/07/26 01:09:11 stevew Exp $
 *========================================================================*/
...
int
BSIM4dev::setModl(int param, IFdata *data, sGENmodel *genmod)
{
    sBSIM4model *mod = static_cast<sBSIM4model*>(genmod);
