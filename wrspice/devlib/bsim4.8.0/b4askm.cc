 ...
 *                                                                        *
 *========================================================================*
 $Id: b4askm.cc,v 1.3 2015/07/26 01:09:11 stevew Exp $
 *========================================================================*/
...
int
BSIM4dev::askModl(const sGENmodel *genmod, int which, IFdata *data)
{
    const sBSIM4model *model = static_cast<const sBSIM4model*>(genmod);
...
// a string.
    ...
    case  BSIM4_MOD_TNOM :
        /* SRW - set as celsius, so return as celsius
                    value->rValue = model->BSIM4tnom;
        */
        value->rValue = model->BSIM4tnom - CONSTCtoK;
        return(OK);
    case BSIM4_MOD_CGSO:
