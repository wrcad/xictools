 ...
 *                                                                        *
 *========================================================================*
 $Id: b4snois.cc,v 1.5 2015/08/08 01:50:45 stevew Exp $
 *========================================================================*/
            ...
            case N_OPEN:
                ...
                if (((NOISEAN*)ckt->CKTcurJob)->NStpsSm != 0)
                {
                    ...
                    case N_DENS:
                        ...
                        {
                            (void) sprintf(b4sname, "onoise.%s%s",
                                           (char*)here->B4SOIname,
                                           B4SOInNames[i]);
                            /* SRW
                    ...
                    case INT_NOIZ:
                        for (i = 0; i < B4SOINSRCS; i++)
                        {
                            (void) sprintf(b4sname, "onoise_total.%s%s",
                                           (char*)here->B4SOIname,
                                           B4SOInNames[i]);
                            /* SRW
                                                                   data->namelist = (IFuid *) trealloc(
                            ...
                            */
                            ...
                            (void) sprintf(b4sname, "inoise_total.%s%s",
                                           (char*)here->B4SOIname,
                                           B4SOInNames[i]);
                            /* SRW
                                                                   data->namelist = (IFuid *) trealloc(
                ...
                case N_DENS:
                    ...
                    if (here->B4SOIrgateMod == 1)
                    {
                        NevalSrc(&noizDens[B4SOIRGNOIZ],
                                 ...
                                 here->B4SOIgNode,
                                 here->B4SOIgNodeExt,
                                 here->B4SOIgrgeltd * tempRatioSH); /* v4.2 self-heating temp */
                    }
                    else if (here->B4SOIrgateMod == 2)    /*v4.2*/
                    {
                        ...
                        NevalSrc(&noizDens[B4SOIRGNOIZ],
                                 ...
                                 here->B4SOIgNode,
                                 here->B4SOIgNodeExt,
                                 here->B4SOIgrgeltd/T1 * tempRatioSH);                            /*v4.2*/
                    }
                    ...
                    if (here->B4SOIrbodyMod)
                    {
                        ...
                        NevalSrc(&noizDens[B4SOIRBDBNOIZ],
                                 ...
                                 here->B4SOIgrbdb * tempRatioSH); /* v4.2 self-heating temp */
                    }
                    else
                    {
                    ...
                    case 1:
                        ...
                        NevalSrc(&noizDens[B4SOIIDNOIZ],
                                 ...
                                 here->B4SOIsNodePrime,
                                 /* (T2 - igsquare)); */
                                 (T2 - igsquare) * tempRatioSH); /* v4.2 self-heating temp */
                        break;
                    ...
                    NevalSrc(&noizDens[B4SOIFB_IBDNOIZ],
                             ...
                             model->B4SOInoif * (here->B4SOIibd));    /*v4.2 extra fabs()removed */
