 ...
 *                                                                        *
 *========================================================================*
 $Id: b4saskm.cc,v 1.5 2015/07/26 01:09:11 stevew Exp $
 *========================================================================*/
...
int
B4SOIdev::askModl(const sGENmodel *genmod, int which, IFdata *data)
{
    const sB4SOImodel *model = static_cast<const sB4SOImodel*>(genmod);
...
// SRW - this was missing
        /* v3.1 for RF */
    case B4SOI_MOD_LXRCRG1 :
        value->rValue = model->B4SOIlxrcrg1;
        return(OK);
    case B4SOI_MOD_LXRCRG2 :
        value->rValue = model->B4SOIlxrcrg2;
        return(OK);
        /* v3.1 for RF end */
...
// SRW - this was missing
    ...
    case B4SOI_MOD_WXRCRG1 :
        value->rValue = model->B4SOIwxrcrg1;
        return(OK);
    case B4SOI_MOD_WXRCRG2 :
        value->rValue = model->B4SOIwxrcrg2;
        return(OK);
        /* v3.1 for RF end */
...
// SRW - this was missing
    ...
    case B4SOI_MOD_PXRCRG1 :
        value->rValue = model->B4SOIpxrcrg1;
        return(OK);
    case B4SOI_MOD_PXRCRG2 :
        value->rValue = model->B4SOIpxrcrg2;
        return(OK);
        /* v3.1 for RF end */
...
// SRW - this was missing
    ...
    case  B4SOI_MOD_NLX:
        value->rValue = model->B4SOInlx;
        return(OK);
    case  B4SOI_MOD_LNLX:
        value->rValue = model->B4SOIlnlx;
        return(OK);
    case  B4SOI_MOD_WNLX:
        value->rValue = model->B4SOIwnlx;
        return(OK);
    case  B4SOI_MOD_PNLX:
        value->rValue = model->B4SOIpnlx;
        return(OK);
    case  B4SOI_MOD_NGIDL:
        value->rValue = model->B4SOIngidl;
        return(OK);
    case  B4SOI_MOD_LNGIDL:
        value->rValue = model->B4SOIlngidl;
        return(OK);
    case  B4SOI_MOD_WNGIDL:
        value->rValue = model->B4SOIwngidl;
        return(OK);
    case  B4SOI_MOD_PNGIDL:
        value->rValue = model->B4SOIpngidl;
        return(OK);
