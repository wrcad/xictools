 ...
 *                                                                        *
 *========================================================================*
 $Id: b4sacld.cc,v 1.2 2011/12/17 06:19:04 stevew Exp $
 *========================================================================*/
...
//                dxpart = 0.6;
            ...
            *(here->B4SOISspPtr) -= gspr -gstots;
            ...
            if (here->B4SOIbodyMod == 1)
            {
                (*(here->B4SOIPpPtr) -= gigpp);
                (*(here->B4SOIPgPtr) -= gigpg);
                (*(here->B4SOIGpPtr) += gigpp);
            }
            else if(here->B4SOIbodyMod == 2)
            {
                (*(here->B4SOIBbPtr) -= gigpp);
                (*(here->B4SOIBgPtr) -= gigpg);
                (*(here->B4SOIGbPtr) += gigpp);
            }
