 ...
 *                                                                        *
 *========================================================================*
 $Id: b4ssetm.cc,v 1.3 2015/07/26 01:09:11 stevew Exp $
 *========================================================================*/
...
int
B4SOIdev::setModl(int param, IFdata *data, sGENmodel *genmod)
{
    sB4SOImodel *mod = static_cast<sB4SOImodel*>(genmod);
