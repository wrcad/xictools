...
SPICE3, and the Common Simulation Data Format (CSDF).  The CSDF is
obsolete, but was once supported by HSPICE and WaveView, and is
retained for backward compatibility.  Currently, WaveView supports
the rawfile format, so CSDF is not required to use WaveView.
