...
% spCommands.hlp:commands 032120
...
as {\cb mcrtial}.  When finished the {\cb check} command should be
...
named {\vt opmin1}, {\vt opmin2}, {\it opmax1}, and {\vt opmax2},
...
<tt>-n1 "</tt>{\it pname\/}<tt>"</tt>, is accepted and the quotes will
...
\bf Resource Parameter Name & \bf Description\\[0.5ex]
\multicolumn{2}{l}{\bf Real-Valued Parameters}\\
{\vt cvchktime} & \rr Time spent convergence testing.&\\
{\vt loadtime} & \rr Device model evaluation and matrix load time.&\\
{\vt lutime} & \rr L-U decomposition time.&\\
{\vt reordertime} & \rr Matrix reordering time.&\\
{\vt solvetime} & \rr Matrix solve time.&\\
{\vt time} & \rr Total analysis time.&\\
{\vt tranlutime} & \rr Transient L-U decomposition time.&\\
{\vt tranouttime} & \rr Transient output recording time.&\\
{\vt transolvetime} & \rr Transient solve time.&\\
{\vt trantime} & \rr Transient time.&\\
{\vt trantstime} & \rr Transient timestep computation time.&\\
\\

\multicolumn{2}{l}{\bf Integer-Valued Parameters}\\
{\vt accept} & \rr Accepted timepoints.&\\
{\vt equations} & \rr Circuit equations.&\\
{\vt fillin} & \rr Fill-in terms from decomposition.&\\
{\vt involcxswitch} & \rr Involuntary context switches during analysis.&\\
{\vt loadthrds} & \rr Number of device loading helper threads.&\\
{\vt loopthrds} & \rr Number of repetitive analysis helper threads.&\\
{\vt matsize} & \rr Matrix size.&\\
{\vt nonzero} & \rr Number of nonzero matrix entries.&\\
{\vt pagefaults} & \rr Number of page faults during analysis.&\\
{\vt rejected} & \rr Number of rejected timepoints.&\\
{\vt runs} & \rr Accumulated core analysis runs.&\\
{\vt totiter} & \rr Total iterations.&\\
{\vt trancuriters} & \rr Transient interations at last timepoint.&\\
{\vt traniter} & \rr Transient interations.&\\
{\vt tranitercut} & \rr Transient timepoints where iteration limit exceeded.&\\
{\vt tranpoints} & \rr Transient timepoints.&\\
{\vt trantrapcut} & \rr Transient timepoints where trapcheck failed.&\\
{\vt volcxswitch} & \rr Voluntary context switches during analysis.&\\
\end{longtable}
