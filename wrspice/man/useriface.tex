...
\item{\vt -\/-v}\\
If this argument is given, all other arguments are ignored, {\WRspice}
will print a version string in the form
\begin{quote}
{\vt 4.1.6 LinuxRHEL6\_64}
\end{quote}
to the standard output, and exit.

\index{command line options!--vv}
\item{\vt -\/-vv}\\
If this argument is given, all other arguments except ``{\vt -\/-v}''
are ignored, {\WRspice} will print a release tag string in the form
\begin{quote}
{\vt wrs-4-1-6}
\end{quote}
to the standard output, and exit.
...
% spSetup.hlp:environment 013016
...
% Hardcopy.hlp:hcopypanel 061608
...
In portrait mode, the plot is in the same orientation
as seen on-screen, and in landscape mode, the image is rotated 90
degrees.  However, if the {\cb Best Fit} button is active, the image
