...
% spVars_cmds.hlp:command_vars 022117
...
\index{installcmdfmt variable}
\item{\et installcmdfmt}\\
Setting this string allows modification of the installation command
used in the {\cb wrupdate} command, for non-Windows releases only.  If
...
password.  The user, who needs to know a bit about Unix shell
...
message will appear that notifies the user.  If this variable is set
in a startup file, this checking will be skipped.
